...
***代码段落***：使用4个***"以上"***的空格或一个**"以上"**的tab标记代码段落，或者`code`,或者区块元素（4空格）, 或者前后\`\`\`包围
...
![img](http://dfdf.com/img.png, "可以是相对路径")  
...
this is an [example link](http://example.com "标题")  
***快速链接***：`<http://elviskwok.github.io>, <359619839@qq.com>`    
<http://elviskwok.github.io>, <359619839@qq.com>  
